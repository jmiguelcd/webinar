...
#
/system identity set name=Torre2
/tool romon set enabled=yes
#
/ip address
add address=10.1.2.2/24 interface=ether1
add address=10.2.2.1/24 interface=ether2
add address=10.2.5.1/24 interface=ether5
/ip pool
...
/ip route
add disabled=no dst-address=0.0.0.0/0 gateway=10.1.2.1
add disabled=no dst-address=10.3.0.0/16 gateway=10.2.2.2
#
#
#
